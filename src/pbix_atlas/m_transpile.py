...
from .m_parser import (
    BinOp, FieldAccess, Ident, If, Invoke, ItemAccess, Lambda, LetExpr,
...
GLOBALS: dict[str, str] = {
    ...
    "Replacer.ReplaceValue": "m_ops.default_replacer", "Replacer.ReplaceText": "m_ops.default_text_replacer",
    "Compression.Deflate": "'deflate'", "TextEncoding.Utf8": "'utf-8'",
    "ExtraValues.Ignore": "'ignore'", "ExtraValues.Error": "'error'",
...
SIMPLE_CALLS: dict[str, str] = {
    "Table.SelectRows": "table_select_rows", "Table.AddColumn": "table_add_column",
    "Table.SelectColumns": "table_select_columns", "Table.RemoveColumns": "table_remove_columns",
    "Table.ReorderColumns": "table_reorder_columns", "Table.Distinct": "table_distinct",
    "Table.ColumnNames": "table_column_names", "Table.NestedJoin": "table_nested_join",
    "Table.Join": "table_nested_join", "Table.ExpandTableColumn": "table_expand_table_column",
    "Table.ExpandRecordColumn": "table_expand_record_column", "Table.CombineColumns": "table_combine_columns",
    "Table.FromRecords": "table_from_records", "Table.FromRows": "table_from_rows",
    "Table.FromList": "table_from_list",
    "Table.Combine": "table_combine", "Table.SplitColumn": "table_split_column",
    "Table.ToRows": "table_to_rows", "Table.ReplaceValue": "table_replace_value",
    "Table.RenameColumns": "table_rename_columns", "Table.Sort": "table_sort",
    "Table.TransformColumnTypes": "table_transform_column_types", "Table.TransformColumns": "table_transform_columns",
    "Table.PromoteHeaders": "table_promote_headers", "Table.Group": "table_group",
    "Table.ReplaceErrorValues": "table_replace_error_values", "Table.Pivot": "table_pivot",
    "List.Select": "list_select", "List.Transform": "list_transform", "List.AnyTrue": "list_any_true",
    "List.RemoveNulls": "list_remove_nulls", "List.Dates": "list_dates", "List.Distinct": "list_distinct",
    "List.Accumulate": "list_accumulate", "List.Contains": "list_contains", "List.First": "list_first",
    "List.Max": "list_max", "List.Sum": "list_sum",
    "Text.Combine": "text_combine", "Text.Contains": "text_contains", "Text.StartsWith": "text_starts_with",
    "Text.EndsWith": "text_ends_with", "Text.Lower": "text_lower", "Text.Upper": "text_upper",
    "Text.Proper": "text_proper", "Text.Trim": "text_trim", "Text.TrimStart": "text_trim_start",
    "Text.TrimEnd": "text_trim_end", "Text.From": "text_from", "Text.Length": "text_length",
    "Text.Replace": "text_replace", "Text.Split": "text_split", "Text.Middle": "text_middle",
    "Text.Start": "text_start", "Text.End": "text_end", "Text.AfterDelimiter": "text_after_delimiter",
    ...
    "Number.From": "number_from", "Number.Round": "number_round", "Number.Abs": "number_abs",
    "Number.IntegerDivide": "number_integer_divide",
    "Date.From": "date_from", "Date.Year": "date_year", "Date.Month": "date_month", "Date.Day": "date_day",
    "Date.DayOfWeek": "date_day_of_week", "Date.WeekOfYear": "date_week_of_year",
    "Date.StartOfWeek": "date_start_of_week", "Date.EndOfWeek": "date_end_of_week", "Date.ToText": "date_to_text",
    "DateTime.LocalNow": "datetime_local_now", "Duration.Days": "duration_days",
    "Record.FieldOrDefault": "record_field_or_default", "Record.Field": "record_field",
    "Value.Is": "value_is", "Binary.FromText": "binary_from_text", "Binary.Decompress": "binary_decompress",
    "Json.Document": "json_document", "Web.Contents": "web_contents", "File.Contents": "file_contents",
    "Folder.Files": "folder_files", "Excel.Workbook": "excel_workbook", "Csv.Document": "csv_document",
    "Sql.Database": "sql_database_handle", "OData.Feed": "odata_feed_handle",
}
...
class MTranspiler:
    ...
    def _invoke(self, node: Invoke, scope: set[str], model_ref: str) -> str:
